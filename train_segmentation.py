...
def main():
    ...
    data_dir = '/kaggle/input/duality-desert-segmentation/duality-desert-segmentation/Offroad_Segmentation_Training_Dataset/train'
    val_dir = '/kaggle/input/duality-desert-segmentation/duality-desert-segmentation/Offroad_Segmentation_Training_Dataset/val'
